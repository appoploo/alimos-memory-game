...
export default function Level() {
  ...
  return (
    <div className=" h-screen w-screen overflow-hidden">
      ...
      <div className="h-full min-h-screen w-screen whole-bg">
        <main className="xs:py-16 md:py-16 lg:py-8">
          ...
          <div className="container mx-auto mt-20 grid  w-full grid-cols-1 place-items-center gap-4">
            ...
            <Link
              role="button"
              className="text-shadow xl:h-30 flex transform  items-center justify-center  rounded-md bg-white text-black text-center font-bold  shadow-lg transition duration-100 hover:text-yellow-300 xs:h-24 xs:w-4/5 md:h-44 md:w-2/3 md:text-3xl lg:h-20 lg:w-1/2 lg:text-lg"
              href={`/game`}
              onClick={() => {
