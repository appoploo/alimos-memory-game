...
export default function Game() {
  ...
  useEffect(() => {
    if (
      !settings.muted &&
      settings.flipCard1.srcf !== settings.flipCard2.srcf &&
  ...
  return (
    <div className=" h-screen w-screen overflow-hidden">
      ...
      <div>
        <div>
          <div className=" h-full min-h-screen w-screen whole-bg xs:py-6 md:py-8 lg:py-4 2xl:py-8">
            ...
            <div className="text-shadow  w-full text-center font-extrabold text-white xs:pb-4 xs:text-xl  md:pb-4 md:text-3xl  lg:text-2xl xl:text-3xl ">
              {settings.level === "easy"
                ? `${t("easy")}`
